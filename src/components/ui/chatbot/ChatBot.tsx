...
export const ChatBot = () => {
  ...
  return (
    <div>
      ...
      <div
        className={` fixed max-sm:inset-0 bg-white p-4 rounded-lg shadow-lg sm:absolute sm:right-0  sm:mr-2 sm:mb-12 sm:w-72 sm:-translate-x-20 sm:-translate-y-52 sm:rounded-lg transition-opacity duration-300 ease-out ${
          openModal
